...
<html>
	...
	<body>
		...
		<nav>
			...
			<div class="container">
				<form style="text-align:center" class="main-cont addemp-form" method="post" action="delitem_process.php">
...
{
echo '<script>						$("#error-cont").html("<h4>Product successfully deleted.</h4>");
						$("#error-cont").css({"padding": "10px"})
</script>';
}
				?>
