<html>
	...
	<div class="container">
				<form class="main-cont addemp-form">
					<a href="admin_dept_2.php"><span class="glyphicon glyphicon-plus-sign"></span></a>
					<h2 style="margin-left: 5px">Department ID</h2><br>
					<table>
						<tr class="one-one">
							<td><input id="" type="text"  placeholder="Department ID"/></td>
						</tr>
						
					</table>
					<button style="margin-left: 10px;width: 15%;" type="submit" class="btn btn-warning">Search</button>
					<button style="margin-left: 10px;width: 15%;" type="submit" class="btn btn-danger">Delete</button>
